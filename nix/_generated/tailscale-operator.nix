    ...
    "tailscale.com.v1alpha1.DNSConfigSpecNameserverPodAffinity" = {
      ...
      options = {
        "nodeAffinity" = mkOption {
          ...
          type = types.nullOr (
            submoduleOf "tailscale.com.v1alpha1.DNSConfigSpecNameserverPodAffinityNodeAffinity"
          );
        };
        "podAffinity" = mkOption {
          description = "Describes pod affinity scheduling rules (e.g. co-locate this pod in the same node, zone, etc. as some other pod(s)).";
          type = types.nullOr (
            submoduleOf "tailscale.com.v1alpha1.DNSConfigSpecNameserverPodAffinityPodAffinity"
          );
        };
    ...
    "tailscale.com.v1alpha1.DNSConfigSpecNameserverPodAffinityNodeAffinityPreferredDuringSchedulingIgnoredDuringExecution" =
      {
        ...
        options = {
          "preference" = mkOption {
            ...
            type = submoduleOf "tailscale.com.v1alpha1.DNSConfigSpecNameserverPodAffinityNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreference";
          };
          "weight" = mkOption {
    ...
    "tailscale.com.v1alpha1.DNSConfigSpecNameserverPodAffinityPodAffinityPreferredDuringSchedulingIgnoredDuringExecution" =
      {
        ...
        options = {
          "podAffinityTerm" = mkOption {
            ...
            type = submoduleOf "tailscale.com.v1alpha1.DNSConfigSpecNameserverPodAffinityPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTerm";
          };
          "weight" = mkOption {
    ...
    "tailscale.com.v1alpha1.DNSConfigSpecNameserverPodAffinityPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecution" =
      {
        ...
        options = {
          "podAffinityTerm" = mkOption {
            description = "Required. A pod affinity term, associated with the corresponding weight.";
            type = submoduleOf "tailscale.com.v1alpha1.DNSConfigSpecNameserverPodAffinityPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTerm";
          };
          "weight" = mkOption {
            description = "weight associated with matching the corresponding podAffinityTerm,\nin the range 1-100.";
            type = types.int;
